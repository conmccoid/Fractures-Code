...
def main(method='AltMin',linesearch='bt'):
    comm=MPI.COMM_WORLD
    rank=comm.rank
    ...
    iter_count=[]
    with open(f"output/TBL_GD_{method}_energy.csv",'w') as csv.file:
