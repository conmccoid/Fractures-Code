...
To compensate for these situations, one can try replacing the information from the gradient with more evaluations of the function, resulting in a P2 finite element:
\begin{align*}
	...
	e = f(\vec{x} + \vec{p}) - f - c,
\end{align*}
with $b$ and $f$ remaining the same.
This requires only two more evaluations of the objective function.
