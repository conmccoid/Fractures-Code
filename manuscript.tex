...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{output/FIG_Surf_energy.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{output/FIG_Surf_outerIts.pdf}
...
AltMin and the parallelogram interpolant give roughly the same number of outer iterations, while the triangle and tetrahedron interpolants requiring about half as many.
The tetrahedron does not appear to signficantly improve over the triangle, though it requires more function evaluations.

\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{output/FIG_Surf_innerIts.pdf}
...
\end{figure}
Computation time is determined not only by the number of outer iterations, but also the number of inner iterations, a measure of the time to solve the inexact Newton step.
...
Cubic backtracking has a high average, at times up to 6, while the three types of interpolants all remain between 3 and 5, averaging 4 over all load steps.

[compare flop counts]

\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{output/FIG_Surf_time.pdf}
...
We see that AltMin has the best time of the accurate methods.
